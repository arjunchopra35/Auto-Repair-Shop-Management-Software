...
function Header()
{
  ...
  $this->Cell(30,8,'ESTIMATE',1,0,'C');
    ...
    $this->Cell(70);
    $this->Cell(40,24,'ESTSYD-'.$year.'-'.$id,0,0,'R');
...
$pdf->Ln();
$pdf->SetXY(10, 220);
$pdf->MultiCell(0,5,$settings['estimate_data']);
$pdf->Ln();
$pdf->Cell(10,30,'Signature : ______________________________');
