...
$db = getDbInstance();
$select = array('id', 'f_name', 'l_name', 'email', 'phone', 'created_at', 'updated_at');
            ...
            <tr>
                ...
                <td>
                    <a href="edit_customer.php?customer_id=<?php echo $row['id']; ?>&operation=edit" class="btn btn-primary"><i class="glyphicon glyphicon-edit"></i></a>
										<a href="customer_history.php?customer_id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="glyphicon glyphicon-time"></i></a>
